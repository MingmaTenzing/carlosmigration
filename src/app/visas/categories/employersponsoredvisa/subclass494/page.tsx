  ...
  return (
    <div className=" space-y-5">
      ...
      <h1 className=" font-bold text-2xl md:text-3xl lg:text-4xl mt-5">
        Ultimate Guide to Subclass 494 Visa in Australia: Requirements,
        Benefits, and Application Process for Skilled Migrants
      </h1>
      <p>
      ...
      <p>
        To be eligible for the 494 visa, you need to meet certain criteria. You
        must have a valid job offer from an Australian employer in a designated
        regional area. Additionally, you must have the skills, qualifications,
        and work experience that match the job requirements.
      </p>

      <h2 className="  font-semibold text-xl md:text-2xl">Conditions</h2>
      <p>
        Once you obtain the 494 visa, it opens up a world of possibilities. You
        can live, work, and study in a designated regional area of Australia for
        up to five years. This visa also provides a pathway to permanent
        residency through the Subclass 191 visa after three years, allowing you
      ...
      <ul className=" space-y-3">
        <li>
          1. Contact Golden Ticket Migration: We are a trusted migration and
          education business in Australia, dedicated to helping individuals like
          you achieve their dreams. Carlos, our experienced advisor, will be
          your companion throughout the visa application process.
        </li>
        <li>
          2. Initial Consultation: Carlos will have a friendly conversation with
          you to understand your goals and assess your eligibility for the 494
          visa. This consultation is a golden opportunity to ask any questions
          you may have and receive personalized guidance based on your unique
          circumstances.
        </li>
        <li>
