...
const reviews = [
  ...
  },
  {
    id: 4,
    reviewText:
      "As a trainer, Carlos possesses a rare combination of knowledge, enthusiasm, and charisma that makes every session engaging and inspiring. He has a knack for simplifying complex concepts and delivering them in a way that resonates with his audience. Carlos creates a supportive and inclusive learning environment, allowing individuals to grow and develop their skills with confidence. ",
    user: "Kevin Martin",
    position: "student",
    photoURL: userPhoto,
  },
