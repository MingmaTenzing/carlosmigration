...
function Services({}: Props) {
  return (
    <div className='  mt-20 relative p-4 md:justify-center md:flex-row md:flex-wrap flex flex-col items-center'>
        <div className='group rounded-lg  z-40 overflow-hidden relative p-4 m-4 cursor-pointer w-[340px] lg:w-[400px] h-[300px] border  flex space-x-8'>
            <div>
        ...
        <div className='group rounded-lg  z-40 overflow-hidden relative p-4 m-4 cursor-pointer w-[340px] lg:w-[400px] h-[300px] border  flex space-x-8'>
            ...
            <div className=' z-30 flex flex-col   justify-center  space-y-2'>
                <h2 className=' font-bold  text-xl  hover:text-orange transition-all ease-linear duration-200'>Immigration Program</h2>
              <p> Lorem ipsum is dolo sit amet, conse ctetur.</p>
        ...
        <div className='group rounded-lg  z-40 overflow-hidden relative p-4 m-4 cursor-pointer w-[340px] lg:w-[400px] h-[300px] border  flex space-x-8'>
            ...
            <div className=' z-30 flex flex-col   justify-center  space-y-2'>
                <h2 className=' font-bold  text-xl  hover:text-orange transition-all ease-linear duration-200'>Documents Required</h2>
              <p> Lorem ipsum is dolo sit amet, conse ctetur.</p>
      ...
      <Image src={map} alt='Map Image' width={401} height={515} className=' hidden lg:flex absolute  -bottom-[200px]   w-[400px] object-cover left-0' />
    </div>
  )
}
